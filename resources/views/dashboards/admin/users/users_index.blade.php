    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
            <div class="flex justify-end p-2">
                <a class="px-4 py-2 text-white bg-blue-700 hover:bg-blue-500 rounded-md" href="{{ route('dashboards.admin.users.create') }}"><i class="fa-user-plus  font-bold"></i> Create User</a>
            </div>
